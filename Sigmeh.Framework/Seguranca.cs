...
namespace Sigmeh.Framework
{
    ...
    {
        public enum HashTipos { MD5, SHA1, SHA256, SHA384, SHA512 };
                                         ...
                                         byte[] saltBytes)
        {
            ...
            switch (hashAlgorithm)
            {
                ...
                case HashTipos.SHA256:
                    hash = new SHA256Managed();
                    break;

                case HashTipos.SHA384:
                    hash = new SHA384Managed();
                    break;

                case HashTipos.SHA512:
